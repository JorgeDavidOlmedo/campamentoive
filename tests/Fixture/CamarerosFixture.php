 ...
 *
 */
class CamarerosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'documento' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'docu_unique_cli' => ['type' => 'unique', 'columns' => ['documento'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
