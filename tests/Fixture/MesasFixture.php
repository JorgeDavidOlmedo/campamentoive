...
class MesasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'estado_actual' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => 'libre', 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'mesas_ibfk_1' => ['type' => 'foreign', 'columns' => ['id_empresa'], 'references' => ['empresas', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
