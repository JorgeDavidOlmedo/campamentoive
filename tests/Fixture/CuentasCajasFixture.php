 ...
 *
 */
class CuentasCajasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tipo' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => 'debe', 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'cuentas_cajas_ibfk_1' => ['type' => 'foreign', 'columns' => ['id_empresa'], 'references' => ['empresas', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
