...
<div class="sidebar" data-color="purple" data-image="../img/sidebar-5.jpg">
    ...
    <div class="content" ng-controller="colectivoEdit" ng-init="cargar_datos(<?php echo $colectivo->id;?>)">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <?= $this->Form->button(__('Guardar'),['class'=>'btn btn-info',"ng-click"=>"modificar($colectivo->id)"]) ?>
