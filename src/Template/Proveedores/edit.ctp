...
<div class="sidebar" data-color="purple" data-image="../../img/sidebar-5.jpg">
    ...
    <div class="content" ng-controller="proveedorEdit" ng-init="cargar_datos(<?php echo $proveedore->id;?>,<?php echo $id_empresa;?>)">
            ...
            <div class="row">
            <div class="col-xs-12 col-sm-4 col-md-4">
            <?=$this->Form->input('documento',array('class' => 'form-control','label'=>'Cedula','ng-model'=>'proveedor.documento'))?>
             </div>
        ...
        <div class="row">
            ...
            <div class="row">
                <hr>
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <?= $this->Form->button(__('Guardar'),['class'=>'btn btn-info',"ng-click"=>"modificar($proveedore->id)"]) ?>
