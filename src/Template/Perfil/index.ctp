            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        ...
                        <p class="category">Lista de Perfiles</p><br>
                        <?= $this->Html->link($this->Html->tag('p','Agregar Nuevo Perfil',['class' => '']).'', 
                    ...
                    <div class="content table-responsive table-full-width">
                        <table class="table table-hover table-striped">
                            ...
                            <tr>
                                ...
                                <td><?= $value->has('id') ? $this->Html->link($value->id, ['controller' => 'Perfil', 'action' => 'view', $value->id]) : '' ?></td>
                                <td><?= $value->has('descripcion') ? $this->Html->link($value->descripcion, ['controller' => 'Perfil', 'action' => 'view', $value->id]) : '' ?></td>
                                <td class="actions">
